...
def test_add_communities_to_lr_with_valid_input()-> None:
    g = graph()
...
def test_add_communities_to_lr_raises_exception_on_invalid_input(communities: str, expected_error_msg: str)-> None:
    g = graph()
