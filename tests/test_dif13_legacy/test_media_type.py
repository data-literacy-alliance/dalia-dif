...
def test_add_media_types_to_lr_with_valid_input() -> None:
    g = graph()
...
def test_add_media_types_to_lr_raises_exception_on_invalid_input(
    media_types: str, expected_error_msg: str
) -> None:
    g = graph()
